...
export function WorkspaceInput(): React.ReactNode {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // For now, just log the form data. In the future, this will trigger the engine.
    console.log('Form submitted:', formData);
    // Reset form? Or keep for review? We'll keep for now.
  };

  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto p-4 bg-white rounded-lg shadow-md">
      <h2 className="mb-4 text-xl font-semibold">Project Inputs</h2>
      ...
      <div className="mb-4">
        <label htmlFor="span" className="block mb-1 font-medium">Span (feet)</label>
        <input
          id="span"
          name="span"
          type="number"
      ...
      <div className="mb-4">
        <label htmlFor="spacing" className="block mb-1 font-medium">Spacing (inches)</label>
        <input
          id="spacing"
          name="spacing"
          type="number"
      ...
      <div className="mb-4">
        <label htmlFor="loadCategory" className="block mb-1 font-medium">Load Category</label>
        <select
          id="loadCategory"
          name="loadCategory"
        ...
        >
          ...
          <option value="Residential Live Load">Residential Live Load</option>
          <option value="Residential Dead Load">Residential Dead Load</option>
