# Ticket Packet: SB-T1-003 — Add input validation primitives for spans, spacing, species, grade, and load category
...
## Product Story
As a user, I want invalid structural inputs rejected clearly so I do not trust impossible results.

## Ownership
- Team: Team 1
- Manager/Profile: span-buddy-team1-manager
- Developer Persona: t1-dev-c-validation-contracts-specialist
- Area: Validation
- Branch: `hermes/team1/input-validation`
- Worktree: `/tmp/span-buddy-worktrees/sb-t1-003`

## Scope
Allowed files/directories:
- `engine/**, app/**, docs/hermes/**`
...
## Acceptance Criteria
- [ ] Zod validation covers core floor-joist inputs
- [ ] Invalid inputs return actionable errors
- [ ] Tests cover boundary/invalid cases
- [ ] No disclaimer weakening
