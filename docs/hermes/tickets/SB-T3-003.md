# Ticket Packet: SB-T3-003 — Define release gate checklist and CI expectations
...
## Product Story
As PM, I want clear release gates so integration decisions are consistent.

## Ownership
- Team: Team 3
- Manager/Profile: span-buddy-team3-manager
- Developer Persona: t3-dev-c-release-readiness-specialist
- Area: Release readiness
- Branch: `hermes/team3/release-gates`
- Worktree: `/tmp/span-buddy-worktrees/sb-t3-003`

## Scope
Allowed files/directories:
- `docs/hermes/**, .github/**, package.json`
...
## Acceptance Criteria
- [ ] verification-report.md defines merge gates
- [ ] CI/workflow state is documented without modifying workflows unless authorized
- [ ] Gate requires Team 3 verification JSON for code changes
- [ ] OpenRouter/free-model compliance checked
