# Ticket Packet: SB-T2-004 — Create printable report shell for future PE review package
...
## Product Story
As a PE reviewer, I want a print-friendly shell that will eventually contain inputs, sized members, citations, and warnings.

## Ownership
- Team: Team 2
- Manager/Profile: span-buddy-team2-manager
- Developer Persona: t2-dev-a-workspace-ui-specialist
- Area: Share/report UX
- Branch: `hermes/team2/printable-report-shell`
- Worktree: `/tmp/span-buddy-worktrees/sb-t2-004`
...
## Acceptance Criteria
- [ ] Print route or component exists as non-final shell
- [ ] Watermark/preliminary language included
- [ ] No PDF/export dependency added without PM approval
- [ ] UI test or snapshot covers shell
